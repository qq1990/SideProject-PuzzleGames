...
import Games.Sudoku.Model.SudokuConfiguration;
...
public class SudokuController {
    ...
    //data to make board
    private final String sudokuData = "src/Games/Sudoku/Resources/SudokuData.txt";
    ...
    /**
     * initialize Games.Sudoku window
    ...
    private void makeRandomSudoku(){
        ...
        messageLabel.setText("Reset a new Games.Sudoku Puzzle");
    }
     ...
     * get data from Games.Sudoku's gridpane and put them in a 2D array grid
